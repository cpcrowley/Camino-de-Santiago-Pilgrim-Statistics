...
var defaultChartWithHeights = function(hColumns, hLines, maxLines) {
  ...
  return [
    ...
    {type:'lines', years:allYears, height:hLines, maxLines:maxLines, usePercent:true}
  ]
}
var longTableSpec = {
...
var options = [
  ...
  charts:defaultChartWithHeights(400,400),
  tableSpec:pageLengthTableSpec(15)},

  //----------------------------------------------------------------------------
  /*{tag:'by-age-month', title:'Age by Month', field:'age',
  charts:defaultChartWithHeights(200,200),
  tableSpec:defaultTableSpec},*/

  //----------------------------------------------------------------------------
  {tag:'by-age', title:'Age', field:'age',
  charts:defaultChartWithHeights(200,250),
  tableSpec:defaultTableSpec},
  ...
  charts:[
    ...
    {type:'lines', years:allYears, height:375, maxLines:13, usePercent:true, skipRow1:true}
  ],
  tableSpec:longTableSpec},

  //----------------------------------------------------------------------------
  {tag:'by-starting-city', title:'Started At', field:'startingCities',
  charts:defaultChartWithHeights(400,400,13),
  tableSpec:longTableSpec},
  ...
  charts:defaultChartWithHeights(300,350),
  tableSpec:defaultTableSpec},
