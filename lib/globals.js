...
var years2015_11_09 = ['2015', '2011', '2005']
var allYears = ['2015', '2014', '2013', '2012', '2011', '2010', '2009', '2008', '2007', '2006', '2005', '2004']
var defaultTableSpec = {
  "lengthChange": false,
  "searching": false,
  "info": false,
  "paging": false,
...
var pageLengthTableSpec = function(pageLength) {
  var ret = _.clone(defaultTableSpec)
  ret.pageLength = pageLength
  return ret
}
var defaultChartWithHeights = function(hColumns, hLines, maxLines) {
  if (!maxLines) maxLines = 999
  return [
    {type:'pie3', years:years2015_11_09, maxLines:maxLines, height:hColumns},
    {type:'columns', years:years2015_11_09, maxLines:maxLines, height:hColumns},
    {type:'lines', years:allYears, maxLines:maxLines, height:hLines, usePercent:true}
  ]
}
var longTableSpec = {
...
var options = [
  ...
  charts:[
    {type:'columns', years:years2015_11_09, height:300},
    {type:'lines', years:allYears, height:400, usePercent:true}
  ],
  tableSpec:pageLengthTableSpec(15)},

  //----------------------------------------------------------------------------
  {tag:'by-age', title:'Age', field:'age',
  charts:[
    {type:'pie3', years:years2015_11_09, height:200},
    {type:'lines', years:allYears, height:250, usePercent:true}
  ],
  ...
  charts:[
    {type:'columns', years:years2015_11_09, height:250},
    {type:'lines', years:allYears, height:325, usePercent:true}
  ],
  tableSpec:defaultTableSpec},
  ...
  charts:[
    {type:'geo', years:['2015'], region:'world', table:geoCountry, height:200, maxLines:13},
    {type:'columns', years:years2015_11_09, height:375, maxLines:13, skipRow1:true},
    {type:'lines', years:allYears, height:400, maxLines:13, usePercent:true, skipRow1:true}
  ],
  tableSpec:longTableSpec},

  //----------------------------------------------------------------------------
  {tag:'by-starting-city', title:'Started At', field:'startingCities',
  charts:[
    {type:'columns', years:years2015_11_09, maxLines:13, height:400},
    {type:'lines', years:allYears, maxLines:13, height:400, usePercent:true}
  ],
  tableSpec:longTableSpec},
  ...
  charts:[
    {type:'columns', years:years2015_11_09, height:350},
    {type:'lines', years:allYears, height:375, usePercent:true}
  ],
  tableSpec:pageLengthTableSpec(20)},

  //----------------------------------------------------------------------------
  {tag:'spanish-by-region', title:'Region', field:'spanishFrom',
  charts:[
    {type:'columns', years:years2015_11_09, height:450},
    {type:'lines', years:allYears, height:450, usePercent:true}
  ],
  tableSpec:pageLengthTableSpec(25)},
]
...
var about = function() {
  ...
  <p><span class="list-item-title">Resizing:</span>
  The charts and tables resize to fit the screen so if you resize the window or
  rotate your mobile device, try moving to another page (like back to "About this site")
  and then back again to get the charts to redraw to fit the new window.
  </p>
  ...
  on October 2, 2016. Added the data for September 2016.
  </p>
...
var footerDiv = function(tag) {
  ...
  switch (tag) {
    ...
    <li><span class="list-item-title">Spain not in charts</span>
    Close to 50% of the pilgrims come from Spain so we remove it from
    the charts so you can see more detail in the other countries.
    Spain is in the table at the bottom.</li>
