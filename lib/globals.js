...
<p><span class="list-item-title">Rows with >= N pilgrims in 2004-2016</span>
...
var footerDiv = function(tag) {
  ...
  switch (tag) {
    ...
    <p><span class="list-item-title">Translations:</span>
...
module.exports = {
  ...
  minPilgrimsInCol: minPilgrimsInCol,
  options: options,
}
