...
var url0 = "http://peregrinossantiago.es/eng/pilgrims-office/statistics/?anio=2015&mes=1";
var urlPrefix = "http://peregrinossantiago.es/eng/pilgrims-office/statistics/?anio=";
...
function getPage(year, month) {
  ...
  request(url, function (error, response, body) {
    ...
    var filename = 'pilgrimData/pd-' + year + '-' + (month ? month : 'all') + '.json';
